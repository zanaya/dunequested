                            ...
                            <div className="widget footer-widget">
                                <div className="th-widget-about">
                                    <div className="about-logo">
                                        <Link to="/">
                                            <img src="/assets/img/logo-white.svg" alt="DuneQuested" />
                                        </Link>
                                    </div>
                                ...
                                <div className="sidebar-gallery">
                                    <div className="gallery-thumb">
                                        <img
                                            ...
                                            alt="Gallery"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_1.webp', e)}
                                        />
                                        <Link
                                            to="///assets/img/widget/gallery_1_1.webp"
                                    ...
                                    <div className="gallery-thumb">
                                        <img
                                            ...
                                            alt="Gallery"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_2.webp', e)}
                                        />
                                        <Link
                                            to="///assets/img/widget/gallery_1_2.webp"
                                            className="gallery-btn popup-image"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_2.webp', e)}
                                        >
                                            <i className="fab fa-instagram" />
                                    ...
                                    <div className="gallery-thumb">
                                        <img
                                            ...
                                            alt="Gallery"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_3.webp', e)}
                                        />
                                        <Link
                                            to="///assets/img/widget/gallery_1_3.webp"
                                            className="gallery-btn popup-image"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_3.webp', e)}
                                        >
                                            <i className="fab fa-instagram" />
                                    ...
                                    <div className="gallery-thumb">
                                        <img
                                            ...
                                            alt="Gallery"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_4.webp', e)}
                                        />
                                        <Link
                                            to="///assets/img/widget/gallery_1_4.webp"
                                            className="gallery-btn popup-image"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_4.webp', e)}
                                        >
                                            <i className="fab fa-instagram" />
                                    ...
                                    <div className="gallery-thumb">
                                        <img
                                            ...
                                            alt="Gallery"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_5.webp', e)}
                                        />
                                        <Link
                                            to="///assets/img/widget/gallery_1_5.webp"
                                            className="gallery-btn popup-image"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_5.webp', e)}
                                        >
                                            <i className="fab fa-instagram" />
                                    ...
                                    <div className="gallery-thumb">
                                        <img
                                            ...
                                            alt="Gallery"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_6.webp', e)}
                                        />
                                        <Link
                                            to="///assets/img/widget/gallery_1_6.webp"
                                            className="gallery-btn popup-image"
                                            onClick={(e) => openModal('/assets/img/widget/gallery_1_6.webp', e)}
                                        >
                                            <i className="fab fa-instagram" />
