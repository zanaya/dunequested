...
function ActivitiesDetailsMain() {
    const images = [
        "/assets/img/tour/standard_desert_safari_1.webp",
        "/assets/img/tour/standard_desert_safari_2.webp",
        "/assets/img/tour/standard_desert_safari_3.webp",
        "/assets/img/tour/standard_desert_safari_4.webp",
    ];
                        ...
                        <div className="tour-page-single">
                            ...
                            <div className="page-content">
                                <div className="page-meta mb-45">
                                    <Link className="page-tag mr-5" to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+Standard+Desert+Safari">
                                        Inquire Now
                                    </Link>
                                ...
                                <h2 className="box-title">Standard Desert Safari (DuneQuested Standard)</h2>
                                <p className="box-text mb-30">
The Standard Desert Safari is DuneQuested's classic evening experience - high-energy dune bashing, short sandboarding, a brief camel walk, sunset photo stop and a relaxed BBQ dinner with cultural entertainment. It's a balanced mix of thrills and lounge-time that suits couples, families and groups.                             </p>
                        ...
                        <aside className="sidebar-area style2">
                            ...
                            <div className="widget tour-booking  ">
                                <p className="widget_subtitle">
                                    From <span className="widget_price">AED 125</span>
                                </p>
                                ...
                                <Link to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+Standard+Desert+Safari" className="th-btn th-icon">
                                    Book Now
                                </Link>
                                ...
                                <div className="offer-banner">
                                    <div className="offer">
                                        ...
                                        <div className="offer">
                                            ...
                                            <Link className="offter-num" to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+Standard+Desert+Safari">
                                                +971 56 459 2414
                                            </Link>
                                        </div>
