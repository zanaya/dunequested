...
function ActivitiesDetailsMain() {
    const images = [
        "/assets/img/tour/XRX_CANAM_1.webp",
        "/assets/img/tour/XRX_CANAM_3.webp",
        "/assets/img/tour/XRX_CANAM_4.webp",
    ];
                        ...
                        <div className="tour-page-single">
                            ...
                            <div className="page-content">
                                <div className="page-meta mb-45">
                                    <Link className="page-tag mr-5" to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+CANAM">
                                        Inquire Now
                                    </Link>
                                ...
                                <h2 className="box-title">Drive high-performance Can-Am desert buggies</h2>
                                <p className="box-text mb-30">
Unleash the full potential of desert power with DuneQuesteds XR-X CanAm Experience - a thrilling ride designed for riders who crave speed, control, and high-end engineering. The XR-X CanAm delivers explosive acceleration, razor-sharp handling, and exceptional suspension performance, making it perfect for carving through soft dunes and sprinting across open desert plains.</p>                                <p className="box-text mb-50">
                                    {" "}
Your journey starts at our desert base, where youll receive a detailed orientation and a short warm-up run. Once comfortable, follow your guide into expansive dune territories, ridge-line tracks, and scenic viewpoints. With its advanced suspension, wide wheelbase, and unmatched torque, the XR-X CanAm ensures a dynamic, smooth, and adrenaline-filled experience for both newcomers and seasoned riders.</p>                                <div className="tour-snapshot">
                                ...
                                <p className="box-text mb-50">
                                    The Can-Am CANAM is famous worldwide for its raw power, stability, and effortless control. With a strong engine, precise steering, and high-travel suspension, it lets you glide over soft dunes, climb steep peaks, and cruise across long desert ridges with confidence.                                </p>
                        ...
                        <aside className="sidebar-area style2">
                            ...
                            <div className="widget tour-booking  ">
                                <p className="widget_subtitle">
                                    From <span className="widget_price">AED 1000</span>
                                </p>
                                ...
                                <Link to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+CANAM" className="th-btn th-icon">
                                    Book Now
                                </Link>
                                ...
                                <div className="offer-banner">
                                    <div className="offer">
                                        ...
                                        <div className="offer">
                                            ...
                                            <Link className="offter-num" to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+CANAM">
                                                +971 56 459 2414
                                            </Link>
                                        </div>
