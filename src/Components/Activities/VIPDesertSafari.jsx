...
function ActivitiesDetailsMain() {
    const images = [
        "/assets/img/tour/vip_desert_safari_1.webp",
        "/assets/img/tour/vip_desert_safari_2.webp",
        "/assets/img/tour/vip_desert_safari_3.webp",
        "/assets/img/tour/vip_desert_safari_4.webp",
                                ...
                                <div className="destination-checklist">
                                    <div className="checklist style4">
                                        <ul>
                                            ...
                                            <li> Single Seater Quad Bike Ride</li>
                        ...
                        <aside className="sidebar-area style2">
                            ...
                            <div className="widget tour-booking  ">
                                <p className="widget_subtitle">
                                    From <span className="widget_price">AED 390</span>
                                </p>
