...
function ActivitiesDetailsMain() {
    const images = [
        "/assets/img/tour/tour_canam_3.webp",
        "/assets/img/tour/tour_canam_1.webp",
        "/assets/img/tour/tour_canam_2.webp",
        "/assets/img/tour/tour_canam_4.webp",
    ];
...
Get ready for the ultimate thrill with DuneQuested's Can-Am CANAM Adventure-a premium desert experience built for high power, sharp control, and unmatched comfort. Known for their incredible engine strength, advanced suspension, and extreme stability, our Can-Am buggies deliver a smooth yet adrenaline-packed ride across Dubai's open red dunes.                                </p>
                                <p className="box-text mb-50">
                                    {" "}
Your journey begins at our desert base where our team provides safety gear and a quick orientation. After a short practice run, follow your expert guide into the open desert. Experience dune climbs, sweeping ridgelines, and scenic viewpoints that offer breathtaking visuals and perfect photo opportunities.                                </p>
                        ...
                        <aside className="sidebar-area style2">
                            ...
                            <div className="widget tour-booking  ">
                                <p className="widget_subtitle">
                                    From <span className="widget_price">AED 700</span>
                                </p>
