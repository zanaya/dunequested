...
function ActivitiesDetailsMain() {
    const images = [
        "/assets/img/tour/raptor_1.webp",
        "/assets/img/tour/raptor_2.webp",
        "/assets/img/tour/raptor_3.webp",
    ];
                        ...
                        <div className="tour-page-single">
                            ...
                            <div className="page-content">
                                <div className="page-meta mb-45">
                                    <Link className="page-tag mr-5" to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+Raptor">
                                        Inquire Now
                                    </Link>
                                ...
                                <h2 className="box-title">Drive high-performance Yamaha Raptor</h2>
                                <p className="box-text mb-30">
                                    Experience raw power and precision handling with DuneQuested's Raptor 750cc Quad Adventure. Our Raptor 750cc machines are tuned for desert performance - high torque for steep dune climbs, wide stance for stability, and robust suspension to smooth out long runs across soft and rutted sand.</p>                                <p className="box-text mb-50">
                                    {" "}
                                    Begin at our desert base for a hands-on orientation and short practice loop. Once comfortable, follow your guide into sweeping dunes and panoramic ridgelines. The Raptor 750cc delivers an intense yet controllable ride that's equally rewarding for experienced riders and confident beginners under guided supervision.</p>                                <div className="tour-snapshot">
                                ...
                                <p className="box-text mb-50">
                                    Expect heart-pumping acceleration, confident cornering, and dramatic desert vistas - all wrapped in a safe, guided experience.                               </p>
                                ...
                                <div className="checklist mb-50">
                                    <ul>
                                        ...
                                        <li>Safe and stable 1-seater design with roll cage + harness</li>
                    ...
                    <div className="col-xxl-4 col-lg-5">
                        <aside className="sidebar-area style2">
                            ...
                            <div className="widget tour-booking  ">
                                ...
                                <Link to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+Raptor" className="th-btn th-icon">
                                    Book Now
                                </Link>
                                ...
                                <div className="offer-banner">
                                    <div className="offer">
                                        ...
                                        <div className="offer">
                                            ...
                                            <Link className="offter-num" to="https://api.whatsapp.com/send?phone=971564592414&text=Hi+DuneQuested%2C%0AI+want+to+make+booking+for+Raptor">
                                                +971 56 459 2414
                                            </Link>
                                        </div>
